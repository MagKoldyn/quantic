...
def walletStep():
    ...
    if n % 4 == 0:
        ...
        n = int(n / 2)
        walletDivision2 = walletDivision2 + 1
...
def process_n():
    while (True):
        if n == 0:
            ...
            f.write(f"Шагов:{steps}. Делений пополам:{walletDivision2}. Делений на 4: {walletDivision4}. Утроений:{walletMultiplication}.\n")
